...
func fileAdvanceOnlyCheck(_ move: Move) -> Bool {
    return fileAdvanceCheck(Move(fromSquare: move.fromSquare, toSquare: move.toSquare)) &&
        !rankAdvanceCheck(Move(fromSquare: move.fromSquare, toSquare: move.toSquare))
}
...
func fileOrRankAdvanceExclusiveCheck(_ move: Move) -> Bool {
    return fileAdvanceOnlyCheck(Move(fromSquare: move.fromSquare, toSquare: move.toSquare)) ||
        rankAdvanceOnlyCheck(Move(fromSquare: move.fromSquare, toSquare: move.toSquare))
}
